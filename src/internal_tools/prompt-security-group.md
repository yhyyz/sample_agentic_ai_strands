...
# 基础信息
1. 原始的代码文件路径/home/ec2-user/environment/clickstream-lakehouse/src/ingestion/alb-nginx-vector/configure-security-groups.sh 

# 你需要完成如下任务
1. 认真读取原始代码有文件，深入理解代码逻辑,之后将configure-security-groups.sh 逻辑转换为python的生产级别代码实现，注意函数参数和注释，必须参数和可选参数按照当前代码逻辑实现
